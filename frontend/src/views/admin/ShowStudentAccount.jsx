...
export default function ShowStudentAccount() {
    ...
    async function fetchData() {
        ...
        try {
            const response = await customAxios.get(`/students/${id}`, {
            headers: {
                ...
                <table className="my-4 text-sm md:text-base w-full max-w-6xl">
                    <tbody>
                        ...
                        {showMore && <>
                            ...
                            <tr className="border-b border-secondary">
                                <th className="text-start py-2">Nom complet du père</th>
                                <td>:</td>
                                <td>{data.parent_full_name}</td>
                            </tr>

                            <tr className="border-b border-secondary">
                                <th className="text-start py-2">Téléphone du père</th>
                                <td>:</td>
                                <td>{data.parent_phone_number}</td>
                            </tr>

                            <tr className="border-b border-secondary">
                                <th className="text-start py-2">Travail du père</th>
                                <td>:</td>
                                <td>{data.parenting_job}</td>
                            </tr>

                            <tr className="border-b border-secondary">
                                <th className="text-start py-2">Groupe sanguin du père</th>
                                <td>:</td>
                                <td>{data.parent_blood_type}</td>
                            </tr>
