...
export default function Alert({alertText, setAlertText, delay = 5_000}) {
  ...
  return (
  <div id="alert-2" className={`${dispaly ? "block" : "hidden"} shadow-2xl pop-up overflow-hidden z-50 absolute top-2 right-2 md:top-4 md:right-4 flex items-center gap-2 p-3 px-2 md:p-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400`} role="alert">
  ...
  <div className="absolute left-0 right-0 h-[3px] bg-red-500 bottom-0 z-50"></div>
  </div>
  )
}